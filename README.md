...
I have noticed that Intercomrades really [appreciate](https://www.intercom.com/blog/emoji-and-stickers-are-just-the-beginning/) [emojis](https://www.intercom.com/blog/emoji-ratings/), so I think you might like [this memory card game 🃏 I have made here](https://github.com/AustinMoninger/memory-card-game), all about remembering emojis 👻.
...
The only dependency in this file is `demjson`. Since the provided JSON data is dirty (keys do not have double quotes), the function `demjson.decode` helped me parse the customer data.
...
Feeling useful and solving *real* problems is a great experience. This summer at Nylas (which is like Twilio for email/calendar; Intercom is a customer!) I had a chance to do just that and grow my product development skills (building things people want!). 🧠

At Nylas, folks on our sales and marketing teams had no way of knowing how customers used our product. That data lived in our logs in Elasticsearch and only for 2 weeks because S3 storage is expensive. And for an engineer to gather any meaningful insights from that log data they would have to figure out how to do Elasticsearch aggregations and would only have 2-week old data to work with.

I got to build a solution to this problem without just being fed requirements——I had to learn about the sales and marketing teams' workflows and how they find the information they want, if at all. This ended up being a dashboard where a user could figure out information such as which customers were hitting which API endpoints, from which email providers, whether those were read or write operations, etc, something that was not possible before.

While I was still at Nylas the sales team used the dashboard to be informed about how a customer used the product prior to follow-up sales calls. Marketing used the dashboard to provide more targeted email outreach to users in the free trial period.

I was really proud of this project because I was laser-focused on my users' needs and iterated quickly based on their feedback. And the result of that focus showed! I grew a lot as an engineer and product developer through this experience and Intercom's focus on the customer lead me to believe that it would be a great fit  
